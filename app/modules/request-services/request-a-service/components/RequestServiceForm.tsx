            ...
            <Popover>
              ...
              <PopoverContent align="end" className="rounded-2xl p-5">
                ...
                <RadioGroup className="space-y-2">
                  <Label htmlFor="per-hour" className="flex justify-between font-normal cursor-pointer">
                    Per hour
                    <RadioGroupItem id="per-hour" value="per-hour" className="w-6 h-6" />
                  </Label>
                  <Label htmlFor="per-service" className="flex justify-between font-normal cursor-pointer">
                    Per service
                    <RadioGroupItem id="per-service" value="per-service" className="w-6 h-6" />
                  </Label>
                </RadioGroup>
              </PopoverContent>
            </Popover>
